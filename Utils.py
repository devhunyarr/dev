RAID = [
    "MADHARCHOD TU APNE BAAP MR DEV SE LADEGA TERI MAA CHODKE FEKK DUNGA RANDI KE PILLLE",                                              
    ...
    "TERI MAA KE CHUTT ME DEV KA LUNDD DAAL DUNGA BSDK",
...
RRAID = [
    ...
    "TERI MAA KI CHUT MAIN REVIL BOT KA LAWDA 🤩🤤🤤",
    "TERI MAA KI CHUT ME DEV KA LUND JAYEGA RANDI KE PILLE 🔥 TERI MAA KO DIN ME TARE DIKH JAYENGE 😂",
    "TERA BAAP MR DEV HAI RANDI KE PILLE TU MR DEV KE LUND PE HAI BSDK RANDI",
    "MR DEV OP 🔥🔥 TERI MAA KI CHUT ME LUND KI TOPI",
